...
if ($managecourse) {
    ...
    foreach ($courses as $course) {
        ...
        if ($managecourse) {
            ...
            echo html_writer::link(new moodle_url('/course/edit.php', ['id' => $course->id]), get_string('update_course',
            'local_final'), ['class' => 'btn btn-update', 'title' => get_string('update_course', 'local_final')]);
            echo html_writer::start_tag('form', ['action' => new moodle_url('/local/final/delete.php'),
            ...
            echo html_writer::empty_tag('button', ['type' => 'submit', 'class' => 'btn btn-delete', 'title' => get_string(
                'delete_course', 'local_final'), 'name' => 'delete', 'text' => get_string('delete_course', 'local_final')]);
            echo html_writer::end_tag('form');
            echo html_writer::link(new moodle_url('/local/final/delete.php', ['id' => $course->id]), get_string('delete_course',
